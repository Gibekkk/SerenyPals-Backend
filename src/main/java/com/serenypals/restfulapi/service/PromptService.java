...
public class PromptService {
        ...
        public Boolean isPolite(String prompt) throws JsonProcessingException {
                String instructions = "Kamu adalah chatbot untuk menjadi administrator yang teliti dan disiplin. Periksa teks yang saya berikan apakah teks tersebut sopan dan ramah atau tidak dari setiap bahasa yang ada, dan periksa juga kata singkatan ataupun plesetan. Saya ingin teks tersebut tidak memiliki kemungkinan sedikit pun untuk menyinggung seseorang dari segi apapun. Berikan respon 'TRUE' jika sopan dan respon 'FALSE' jika tidak. Saya ingin respon kamu bersih dan tidak memiliki tanda baca seperti bold, italic, new line, dan lain sebagainya. Respon yang saya minta hanya berisi 1 kata sesuai instruksi sebelumnya.";
                ...
                HttpRequest request = HttpRequest.newBuilder()
                                ...
                                .POST(HttpRequest.BodyPublishers.ofString(jsonBody)) // no payload
